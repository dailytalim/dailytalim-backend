...
import { r as ref, g as createElementBlock, i as createBaseVNode, L as createStaticVNode, y as createTextVNode, f as openBlock } from "./runtime-dom.esm-bundler-C6XC7_wD.js";
/*!
...
const _hoisted_1 = { class: "items-center justify-center min-h-screen bg-gradient-to-r flex flex-col" };
const _hoisted_2 = { class: "content p-4" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const downloadCard = () => __async(this, null, function* () {
      try {
        if (!cardRef.value) return;
        const canvas = yield html2canvas(cardRef.value);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          ...
          _cache[0] || (_cache[0] = createBaseVNode("div", { class: "header bg-gradient-to-r from-green-600 to-emerald-500 text-white p-4 text-center" }, [
            createBaseVNode("h2", { class: "text-3xl font-bold tracking-wide" }, "আজকের তালিম")
          ], -1)),
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("p", {
              innerHTML: __props.hadith.description,
              class: "text-gray-700 text-base leading-relaxed text-justify"
            }, null, 8, _hoisted_3)
          ]),
          _cache[1] || (_cache[1] = createStaticVNode('<div class="footer bg-gray-50 border-t border-gray-200 px-8 py-4 flex justify-between items-center"><p class="text-green-600 font-semibold text-sm hover:text-green-700 transition"><i class="ri-book-open-line"></i> Daily Talim | <i class="ri-global-line"></i> dailytalim.com | <i class="ri-facebook-fill"></i>/DailyTalimBD </p></div>', 1))
        ], 512),
        createBaseVNode("div", { class: "flex gap-4 items-center" }, [
          createBaseVNode("div", { class: "mt-4" }, [
            createBaseVNode("button", {
              ...
              createBaseVNode("i", { class: "ri-download-2-line" }, null, -1),
