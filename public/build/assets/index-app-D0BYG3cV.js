...
import { r as ref, o as onMounted, g as createElementBlock, i as createBaseVNode, q as createCommentVNode, f as openBlock } from "./runtime-dom.esm-bundler-CnJVbtqA.js";
/*!
...
const _hoisted_1 = { class: "hadith-container" };
const _hoisted_2 = {
  key: 0,
  class: "image-preview"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const generateImage = () => __async(this, null, function* () {
      try {
    ...
    const shareImage = () => __async(this, null, function* () {
      if (!imageSrc.value) return;
      try {
        if (navigator.share) {
          const response = yield fetch(imageSrc.value);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        imageSrc.value ? (openBlock(), createElementBlock("div", _hoisted_4, [
