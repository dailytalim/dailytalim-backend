...
import { d as defineComponent, s as shallowRef, o as onMounted, ad as onBeforeUnmount, h, r as ref, ag as watchEffect, m as markRaw, ah as customRef, I as nextTick, u as unref, ai as getCurrentInstance, f as createElementBlock, g as openBlock, i as createBaseVNode, n as normalizeClass, ab as withDirectives, j as createVNode, l as createBlock, p as createCommentVNode, a9 as withModifiers, ac as vShow, aj as vModelText } from "./runtime-dom.esm-bundler-CDgXytbd.js";
...
class Extension {
  ...
  extend(extendedConfig = {}) {
    const extension = new Extension(__spreadValues(__spreadValues({}, this.config), extendedConfig));
    extension.parent = this;
    this.child = extension;
    extension.name = extendedConfig.name ? extendedConfig.name : extension.parent.name;
    if (extendedConfig.defaultOptions && Object.keys(extendedConfig.defaultOptions).length > 0) {
      ...
      new Plugin({
        ...
        props: {
          clipboardTextSerializer: () => {
            ...
            return getTextBetween(doc2, range, __spreadProps(__spreadValues({}, this.options.blockSeparator !== void 0 ? { blockSeparator: this.options.blockSeparator } : {}), {
              textSerializers
            }));
          }
        }
...
const updateAttributes = (typeOrName, attributes = {}) => ({ tr: tr2, state, dispatch }) => {
  ...
  if (dispatch) {
    tr2.selection.ranges.forEach((range) => {
            ...
            if (markType && node.marks.length) {
              node.marks.forEach((mark) => {
                if (markType === mark.type) {
                  ...
                  tr2.addMark(trimmedFrom2, trimmedTo2, markType.create(__spreadValues(__spreadValues({}, mark.attrs), attributes)));
                }
              });
            }
          }
      ...
      if (lastNode) {
        if (lastPos !== void 0) {
          tr2.setNodeMarkup(lastPos, void 0, __spreadValues(__spreadValues({}, lastNode.attrs), attributes));
        }
...
class NodePos {
  ...
  setAttribute(attributes) {
    ...
    tr2.setNodeMarkup(this.from, void 0, __spreadValues(__spreadValues({}, this.node.attrs), attributes));
    ...
    watchEffect(() => {
      ...
      if (editor && editor.options.element && rootEl.value) {
        nextTick(() => {
          ...
          if (instance) {
            editor.appContext = __spreadProps(__spreadValues({}, instance.appContext), {
  ...
  addInputRules() {
    ...
    if (this.options.keepMarks || this.options.keepAttributes) {
      inputRule = wrappingInputRule({
        ...
        keepMarks: this.options.keepMarks,
        keepAttributes: this.options.keepAttributes,
        getAttributes: (match) => __spreadValues({ start: +match[1] }, this.editor.getAttributes(TextStyleName)),
        joinPredicate: (match, node) => node.childCount + node.attrs.start === +match[1],
        editor: this.editor
      });
    }
...
const Link = Mark2.create({
  ...
  renderHTML({ HTMLAttributes }) {
    if (!this.options.isAllowedUri(HTMLAttributes.href, {
      ...
      return [
        "a",
        mergeAttributes(this.options.HTMLAttributes, __spreadProps(__spreadValues({}, HTMLAttributes), { href: "" })),
        0
      ];
    }
...
function mergeCells(state, dispatch) {
  ...
  if (dispatch) {
    ...
    tr2.setNodeMarkup(mergedPos + rect.tableStart, null, __spreadProps(__spreadValues({}, addColSpan(
      mergedCell.attrs,
...
function splitCellWithType(getCellType) {
  return (state, dispatch) => {
    ...
    if (dispatch) {
      ...
      if (baseAttrs.rowspan > 1) baseAttrs = __spreadProps(__spreadValues({}, baseAttrs), { rowspan: 1 });
      if (baseAttrs.colspan > 1) baseAttrs = __spreadProps(__spreadValues({}, baseAttrs), { colspan: 1 });
      const rect = selectedRect(state), tr2 = state.tr;
      for (let i = 0; i < rect.right - rect.left; i++)
        attrs.push(
          colwidth ? __spreadProps(__spreadValues({}, baseAttrs), {
...
function isolateHorizontal(tr2, map2, table, start, left, right, top, mapFrom) {
  ...
  for (let col = left; col < right; col++) {
    ...
    if (map2.map[index - map2.width] == pos) {
      ...
      tr2.setNodeMarkup(tr2.mapping.slice(mapFrom).map(pos + start), null, __spreadProps(__spreadValues({}, cell.attrs), {
        rowspan: top - cellTop
      }));
      tr2.insert(
...
function updateColumnWidth(view, cell, width) {
  ...
  for (let row = 0; row < map2.height; row++) {
    ...
    tr2.setNodeMarkup(start + pos, null, __spreadProps(__spreadValues({}, attrs), { colwidth }));
  }
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        createBaseVNode("i", {
          class: normalizeClass(["text-centertext-sm m-0 cursor-pointer break-words bg-no-repeat p-0 not-italic leading-5", __props.icon])
        }, null, 2)
      ], 8, _hoisted_1$2);
    };
  }
...
const _sfc_main$1 = {};
const _hoisted_1$1 = { class: "my-0 ml-2 mr-2 h-5 w-px break-words bg-skin-neutral-6 bg-no-repeat p-0 font-sans text-sm leading-5 tracking-normal" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$1);
}
const TipTapDivider = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render]]);
  ...
  addCommands() {
    const isFileTypeAllowed = (fileType) => {
      ...
      return allowedTypes.some(
        (type) => fileType.includes(type.replace("*", ""))
      );
    };
    return {
      uploadFile: () => ({ editor }) => {
        ...
        input.onchange = () => __async(this, null, function* () {
          ...
          const maxSizeInBytes = this.options.maximumFileSize * 1024 * 1024;
          if (file && file.size <= maxSizeInBytes && isFileTypeAllowed(file.type)) {
...
const _hoisted_1 = { class: "mx-0 mb-0 flex flex-none flex-wrap items-center break-words border-x border-t border-solid border-skin-neutral-7 border-t-skin-neutral-7 bg-no-repeat p-2 font-sans text-xl leading-5 tracking-normal" };
const _hoisted_2 = ["id"];
const _sfc_main = {
  __name: "AppTipTapEditor",
  props: {
    modelValue: {
      type: String,
      default: ""
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onUploadCompleted = (event, editor2) => {
      const data = JSON.parse(event.target.response);
      editor2.chain().setImage({
        src: data.fileUrl,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", {
          class: normalizeClass(["mx-0 mb-0 mt-1 flex flex-none flex-wrap items-center break-words rounded-t-md border-x border-t border-solid border-skin-neutral-7 bg-no-repeat p-2 font-sans text-xl leading-5 tracking-normal", __props.editorClass])
        }, [
          createVNode(_sfc_main$2, {
            title: _ctx.__("Bold"),
            icon: "ri-bold",
            onClick: _cache[0] || (_cache[0] = withModifiers(($event) => unref(editor).commands.toggleBold(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Italic"),
            icon: "ri-italic",
            onClick: _cache[1] || (_cache[1] = withModifiers(($event) => unref(editor).commands.toggleItalic(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Underline"),
            icon: "ri-underline",
            onClick: _cache[2] || (_cache[2] = withModifiers(($event) => unref(editor).commands.toggleUnderline(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Strikethrough"),
            icon: "ri-strikethrough",
            onClick: _cache[3] || (_cache[3] = withModifiers(($event) => unref(editor).commands.toggleStrike(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Heading 1"),
            icon: "ri-h-1",
            onClick: _cache[4] || (_cache[4] = withModifiers(($event) => unref(editor).commands.toggleHeading({ level: 1 }), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Heading 2"),
            icon: "ri-h-2",
            onClick: _cache[5] || (_cache[5] = withModifiers(($event) => unref(editor).commands.toggleHeading({ level: 2 }), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Heading 3"),
            icon: "ri-h-3",
            onClick: _cache[6] || (_cache[6] = withModifiers(($event) => unref(editor).commands.toggleHeading({ level: 3 }), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Heading 4"),
            icon: "ri-h-4",
            onClick: _cache[7] || (_cache[7] = withModifiers(($event) => unref(editor).commands.toggleHeading({ level: 4 }), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Paragraph"),
            icon: "ri-paragraph",
            onClick: _cache[8] || (_cache[8] = withModifiers(($event) => unref(editor).commands.setParagraph(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("List"),
            icon: "ri-list-unordered",
            onClick: _cache[9] || (_cache[9] = withModifiers(($event) => unref(editor).commands.toggleBulletList(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Ordered Link"),
            icon: "ri-list-ordered",
            onClick: _cache[10] || (_cache[10] = withModifiers(($event) => unref(editor).commands.toggleOrderedList(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Add Link"),
            icon: "ri-link-m",
            onClick: withModifiers(setLink, ["prevent"])
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Remove Link"),
            icon: "ri-link-unlink-m",
            onClick: _cache[11] || (_cache[11] = withModifiers(($event) => unref(editor).commands.unsetLink(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Line Break"),
            icon: "ri-text-wrap",
            onClick: _cache[12] || (_cache[12] = withModifiers(($event) => unref(editor).commands.setHardBreak(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Horizontal Rule"),
            icon: "ri-separator",
            onClick: _cache[13] || (_cache[13] = withModifiers(($event) => unref(editor).commands.setHorizontalRule(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Clear Format"),
            icon: "ri-format-clear",
            onClick: _cache[14] || (_cache[14] = withModifiers(($event) => unref(editor).commands.clearNodes(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          __props.fileUploadUrl ? (openBlock(), createBlock(_sfc_main$2, {
            key: 0,
            title: _ctx.__("Add Image"),
            icon: "ri-image-add-line",
            onClick: withModifiers(uploadFile, ["prevent"])
          }, null, 8, ["title"])) : createCommentVNode("", true),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Add Video"),
            icon: "ri-youtube-line",
            onClick: withModifiers(addVideo, ["prevent"])
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Table"),
            icon: "ri-table-line",
            onClick: withModifiers(toggleTableToolbar, ["prevent"])
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Undo"),
            icon: "ri-arrow-go-back-line",
            onClick: _cache[15] || (_cache[15] = withModifiers(($event) => unref(editor).commands.undo(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Redo"),
            icon: "ri-arrow-go-forward-line",
            onClick: _cache[16] || (_cache[16] = withModifiers(($event) => unref(editor).commands.redo(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Code View"),
            icon: "ri-code-box-line",
            onClick: withModifiers(changeEditorMode, ["prevent"])
          }, null, 8, ["title"])
        ], 2),
        withDirectives(createBaseVNode("div", _hoisted_1, [
          createVNode(_sfc_main$2, {
            title: _ctx.__("Insert Table"),
            icon: "ri-table-2",
            onClick: _cache[17] || (_cache[17] = withModifiers(($event) => unref(editor).commands.insertTable({
              rows: 3,
              cols: 3,
              withHeaderRow: true
            }), ["prevent"]))
          ...
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Add Column Before"),
            icon: "ri-layout-3-line",
            onClick: _cache[18] || (_cache[18] = withModifiers(($event) => unref(editor).commands.addColumnBefore(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Add Column After"),
            icon: "ri-layout-6-line",
            onClick: _cache[19] || (_cache[19] = withModifiers(($event) => unref(editor).commands.addColumnAfter(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Delete Column"),
            icon: "ri-delete-column",
            onClick: _cache[20] || (_cache[20] = withModifiers(($event) => unref(editor).commands.deleteColumn(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Add Row Before"),
            icon: "ri-insert-row-top",
            onClick: _cache[21] || (_cache[21] = withModifiers(($event) => unref(editor).commands.addRowBefore(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Add Row After"),
            icon: "ri-insert-row-bottom",
            onClick: _cache[22] || (_cache[22] = withModifiers(($event) => unref(editor).commands.addRowAfter(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Delete Row"),
            icon: "ri-delete-row",
            onClick: _cache[23] || (_cache[23] = withModifiers(($event) => unref(editor).commands.deleteRow(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Merge Cells"),
            icon: "ri-merge-cells-horizontal",
            onClick: _cache[24] || (_cache[24] = withModifiers(($event) => unref(editor).commands.mergeCells(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Split Cell"),
            icon: "ri-split-cells-horizontal",
            onClick: _cache[25] || (_cache[25] = withModifiers(($event) => unref(editor).commands.splitCell(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Alternate Column Header"),
            icon: "ri-archive-drawer-line",
            onClick: _cache[26] || (_cache[26] = withModifiers(($event) => unref(editor).commands.toggleHeaderColumn(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Alternate Row Header"),
            icon: "ri-archive-drawer-fill",
            onClick: _cache[27] || (_cache[27] = withModifiers(($event) => unref(editor).commands.toggleHeaderRow(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Alternate Cell Header"),
            icon: "ri-split-cells-vertical",
            onClick: _cache[28] || (_cache[28] = withModifiers(($event) => unref(editor).commands.toggleHeaderCell(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Merge or Split"),
            icon: "ri-merge-cells-vertical",
            onClick: _cache[29] || (_cache[29] = withModifiers(($event) => unref(editor).commands.mergeOrSplit(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Go to Next Cell"),
            icon: "ri-arrow-right-s-line",
            onClick: _cache[30] || (_cache[30] = withModifiers(($event) => unref(editor).chain().focus().goToNextCell().run(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Go to Previous Cell"),
            icon: "ri-arrow-left-s-line",
            onClick: _cache[31] || (_cache[31] = withModifiers(($event) => unref(editor).chain().focus().goToPreviousCell().run(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(TipTapDivider),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Fix Table"),
            icon: "ri-settings-line",
            onClick: _cache[32] || (_cache[32] = withModifiers(($event) => unref(editor).commands.fixTables(), ["prevent"]))
          }, null, 8, ["title"]),
          createVNode(_sfc_main$2, {
            title: _ctx.__("Delete Table"),
            icon: "ri-delete-bin-2-line",
            onClick: _cache[33] || (_cache[33] = withModifiers(($event) => unref(editor).commands.deleteTable(), ["prevent"]))
          }, null, 8, ["title"])
        ], 512), [
          [vShow, showTableToolbar.value]
        ]),
        withDirectives(createVNode(unref(EditorContent), {
          editor: unref(editor),
          ...
          [vShow, !codeMode.value]
        ]),
        withDirectives(createBaseVNode("textarea", {
          id: __props.editorId,
          "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => htmlContent.value = $event),
