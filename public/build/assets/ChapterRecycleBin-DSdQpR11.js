import { _ as _sfc_main$2, a as _sfc_main$3, b as _sfc_main$4, c as __unplugin_components_3, d as __unplugin_components_4, e as __unplugin_components_5, f as _sfc_main$5 } from "./AppDataSearch-j_cyJ10j.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(_component_AppSectionHeader, {
          ...
          right: withCtx(() => [
            createBaseVNode("div", _hoisted_1, [
              unref(can)("chapter-list") ? (openBlock(), createBlock(_component_AppButton, {
                key: 0,
                class: "btn btn-secondary",
                onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$inertia.visit(_ctx.route("chapter.index")))
              }, {
              ...
              unref(can)("chapter-recycle-bin-restore") ? (openBlock(), createBlock(_component_AppButton, {
                key: 1,
                class: "btn btn-primary",
                onClick: _cache[1] || (_cache[1] = ($event) => _ctx.$inertia.visit(_ctx.route("chapter.RecycleBin.restore")))
              }, {
              ...
              unref(can)("chapter-recycle-bin-delete") ? (openBlock(), createBlock(_component_AppButton, {
                key: 2,
                class: "btn btn-destructive",
                onClick: _cache[2] || (_cache[2] = ($event) => confirmDelete(_ctx.route("chapter.recycleBin.empty")))
              }, {
        ...
        __props.chapters.data.length || _ctx.route().params.searchTerm ? (openBlock(), createBlock(_component_AppDataSearch, {
          key: 0,
          url: _ctx.route("chapter.recycleBin"),
          "fields-to-search": "name"
        }, null, 8, ["url"])) : createCommentVNode("", true),
        __props.chapters.data.length ? (openBlock(), createBlock(_component_AppDataTable, {
          key: 1,
          headers
        }, {
          TableBody: withCtx(() => [
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.chapters.data, (item, index) => {
                return openBlock(), createBlock(_component_AppDataTableRow, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_AppDataTableData, null, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString((__props.chapters.current_page - 1) * __props.chapters.per_page + (index + 1)), 1)
                      ]),
                      _: 2
                    }, 1024),
                    createVNode(_component_AppDataTableData, null, {
                    ...
                    createVNode(_component_AppDataTableData, null, {
                      default: withCtx(() => [
                        unref(can)("chapter-recycle-bin-restore") ? (openBlock(), createBlock(_component_AppTooltip, {
                          key: 0,
                          text: "Restore",
                          class: "mr-2"
                        }, {
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => _ctx.$inertia.visit(
                                _ctx.route("chapter.restore", item.id)
                              )
                            }, {
                        ...
                        unref(can)("chapter-recycle-bin-delete") ? (openBlock(), createBlock(_component_AppTooltip, {
                          key: 1,
                          ...
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => confirmDelete(
                                _ctx.route("chapter.destroyForce", item.id)
                              )
                            }, {
        ...
        createVNode(_component_AppPaginator, {
          links: __props.chapters.links,
          from: (_a = __props.chapters.from) != null ? _a : 0,
          to: (_b = __props.chapters.to) != null ? _b : 0,
          total: (_c = __props.chapters.total) != null ? _c : 0,
          class: "mt-4 justify-center"
        }, null, 8, ["links", "from", "to", "total"]),
        !__props.chapters.data.length ? (openBlock(), createBlock(_component_AppAlert, {
          key: 2,
          class: "mt-4"
        }, {
