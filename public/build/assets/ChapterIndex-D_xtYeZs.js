        ...
        createVNode(_component_AppSectionHeader, {
          ...
          right: withCtx(() => [
            createBaseVNode("div", _hoisted_1, [
              unref(can)("chapter-create") ? (openBlock(), createBlock(_component_AppButton, {
                key: 0,
                class: "btn btn-primary",
                onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$inertia.visit(_ctx.route("chapter.create")))
              }, {
                default: withCtx(() => _cache[2] || (_cache[2] = [
                  createBaseVNode("i", { class: "ri-add-fill mr-1" }, null, -1),
                  createTextVNode(" Add chapter ")
                ])),
                _: 1
              })) : createCommentVNode("", true),
              unref(can)("chapter-recycle-bin-list") ? (openBlock(), createBlock(_component_AppButton, {
                key: 1,
                class: "btn btn-secondary",
                onClick: _cache[1] || (_cache[1] = ($event) => _ctx.$inertia.visit(_ctx.route("chapter.recycleBin.index")))
              }, {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.chapters.data, (item, index) => {
                return openBlock(), createBlock(_component_AppDataTableRow, {
                  ...
                  default: withCtx(() => [
                    ...
                    createVNode(_component_AppDataTableData, null, {
                      default: withCtx(() => [
                        unref(can)("chapter-edit") ? (openBlock(), createBlock(_component_AppTooltip, {
                          key: 0,
                          text: "Edit",
                          class: "mr-2"
                        }, {
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => _ctx.$inertia.visit(
                                _ctx.route("chapter.edit", item.id)
                              )
                            }, {
                        ...
                        unref(can)("chapter-delete") ? (openBlock(), createBlock(_component_AppTooltip, {
                          key: 1,
                          text: "Delete"
                        }, {
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => confirmDelete(
                                _ctx.route("chapter.destroy", item.id)
                              )
                            }, {
