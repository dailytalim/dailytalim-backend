import { _ as __unplugin_components_2$1 } from "./AppTextArea-sFKvssBq.js";
import { b as _sfc_main$1 } from "./AppInputText-zGYkzQim.js";
import { _ as __unplugin_components_2 } from "./AppLabel-CW1bbGwg.js";
import { r as ref, o as onMounted, g as createElementBlock, i as createBaseVNode, a8 as withModifiers, aa as withDirectives, ab as vShow, u as unref, F as Fragment, t as toDisplayString, j as createVNode, k as withCtx, n as normalizeClass, q as createCommentVNode, f as openBlock, y as createTextVNode } from "./runtime-dom.esm-bundler-CnJVbtqA.js";
import { u as useFormErrors } from "./useFormErrors-Cq2ZeyMU.js";
import { u as useFormContext } from "./useFormContext-irIFvdmS.js";
import { u as usePostStore } from "./PostStore-D54wgOLS.js";
import "./app-CIBQdNIk.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const toggleSeoForm = () => {
      if (!showSeoForm.value && isCreate.value && !postStore.post.meta_tag_title.length && !postStore.post.meta_tag_description.length) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        withDirectives(createBaseVNode("small", _hoisted_3, " (fill the title and description to see a preview) ", 512), [
          [vShow, unref(postStore).showSeoAlert()]
        ]),
        showSeoForm.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", null, [
            createBaseVNode("div", _hoisted_4, [
              ...
              createBaseVNode("div", _hoisted_5, [
                ...
                createBaseVNode("p", _hoisted_6, " https://your-domain.com/blog/post/" + toDisplayString(unref(postStore).getSlug()), 1)
              ])
            ]),
            createBaseVNode("div", null, [
              createBaseVNode("p", _hoisted_7, toDisplayString(unref(postStore).post.meta_tag_title), 1),
              createBaseVNode("p", _hoisted_8, toDisplayString(unref(postStore).post.meta_tag_description), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_9, [
            ...
            createVNode(_component_AppInputText, {
              id: "meta_tag_title",
              modelValue: unref(postStore).post.meta_tag_title,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(postStore).post.meta_tag_title = $event),
              type: "text",
              maxlength: "60",
            ...
            createBaseVNode("small", _hoisted_10, toDisplayString(unref(postStore).getRemainingChars("meta_tag_title", 60)) + " of 60 ", 1)
          ]),
          createBaseVNode("div", _hoisted_11, [
            ...
            createVNode(_component_AppTextArea, {
              ...
              modelValue: unref(postStore).post.meta_tag_description,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(postStore).post.meta_tag_description = $event),
            ...
            createBaseVNode("small", _hoisted_12, toDisplayString(unref(postStore).getRemainingChars("meta_tag_description", 160)) + " of 160 ", 1)
          ])
