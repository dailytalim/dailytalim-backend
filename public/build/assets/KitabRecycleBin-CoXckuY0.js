    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          right: withCtx(() => [
            createBaseVNode("div", _hoisted_1, [
              ...
              unref(can)("kitab-recycle-bin-restore") ? (openBlock(), createBlock(_component_AppButton, {
                ...
                onClick: _cache[1] || (_cache[1] = ($event) => _ctx.$inertia.visit(_ctx.route("kitab.RecycleBin.restore")))
              }, {
        ...
        __props.kitabs.data.length || _ctx.route().params.searchTerm ? (openBlock(), createBlock(_component_AppDataSearch, {
          key: 0,
          url: _ctx.route("kitab.recycleBin"),
                          ...
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => _ctx.$inertia.visit(
                                _ctx.route("kitab.restore", item.id)
                              )
                            }, {
                          ...
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => confirmDelete(
                                _ctx.route("kitab.destroyForce", item.id)
                              )
                            }, {
