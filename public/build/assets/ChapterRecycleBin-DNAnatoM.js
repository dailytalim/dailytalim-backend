...
import { u as useAuthCan, m as me } from "./app-eEjzJFVR.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          right: withCtx(() => [
            createBaseVNode("div", _hoisted_1, [
              ...
              unref(can)("chapter-recycle-bin-restore") ? (openBlock(), createBlock(_component_AppButton, {
                ...
                onClick: _cache[1] || (_cache[1] = ($event) => _ctx.$inertia.visit(_ctx.route("chapter.recycleBin.restoreAll")))
              }, {
        ...
        __props.chapters.data.length || _ctx.route().params.searchTerm ? (openBlock(), createBlock(_component_AppDataSearch, {
          key: 0,
          url: _ctx.route("chapter.recycleBin.index"),
                          ...
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => _ctx.$inertia.visit(
                                _ctx.route("chapter.recycleBin.restore", item.id)
                              )
                            }, {
                          ...
                          default: withCtx(() => [
                            createVNode(_component_AppButton, {
                              ...
                              onClick: ($event) => confirmDelete(
                                _ctx.route("chapter.recycleBin.destroyForce", item.id)
                              )
                            }, {
